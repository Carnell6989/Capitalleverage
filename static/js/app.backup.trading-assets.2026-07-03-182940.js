...
User instructions:
${input || "No extra instructions yet. Give a strong starter plan."}

Mandatory risk rule:
- Maximum stop loss is 1% per trade.
- Do not suggest risking more than 1% per trade.
- Start with paper trading only.
- Do not guarantee profits.
- Do not give reckless financial promises.
- Build a practical system for testing before live trading.

Build for:
1. OpenAlice setup
2. Alpaca paper trading setup
3. 24/7 VPS bot structure
4. Watchlist rules
5. Entry rules
6. Exit rules
7. 1% stop loss rule
